...
def get_leg_angles(delta_x, delta_z, leg_tag, cc):
    possible_angles = find_angles(delta_x, delta_z, leg_tag, cc)

    return get_best_angles(possible_angles)

def find_angles(Dx, Dy, leg_tag, cc):
